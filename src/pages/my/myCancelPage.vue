  ...
  <v-container>
    <div class="d-flex">
      <div class="ma-4 font-bold">
        <h2 class="font-bold">已取消</h2>
        <span style="font-size:96px;">{{ numberOfCancel }}</span><span style="font-size:30px;">件</span>
      </div>
      <div class="ma-4 font-bold">
    ...
    >
      <v-card>
        ...
        <v-card-text>
          <form-page :key="formKey" restrict-mode="cancel_view" :form-param="formParam" />
        </v-card-text>
...
<script src="./myCancelPage.js"></script>