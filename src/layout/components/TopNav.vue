  ...
  >
    ...
    <v-toolbar-items class="d-flex align-center">
      ...
      >
        ...
        <fet-toolbar-notification :data="data" />
      </v-menu>
      ...
      >
        ...
        <fet-toolbar-notification :data="data2" />
      </v-menu>
      ...
      >
        ...
        <fet-toolbar-notification :data="data3" />
      </v-menu>
