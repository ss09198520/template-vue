...
export default{
    ...
    methods:{
        ...
        search(){
            this.empMockList = [
                //台中區處
                { mani:'123', empId: '1050330-001', empName: '梁朝偉', empLeave:'2021/09/10 08:00-2021/09/11 17:00', agentId:'1050331-001', agentName:'蔡政揚',leaveDataFrom:'差假管理系統'},
                { mani:'123', empId: '1050330-002', empName: '王曉花', empLeave:'2021/09/10 08:00-2021/09/11 17:00', agentId:'1050330-002', agentName:'王曉花', leaveDataFrom:'差假管理系統'},
                { mani:'123', empId: '1050330-003', empName: '林美美', empLeave:'2021/09/09 08:00-2021/09/11 17:00', agentId:'1050330-001', agentName:'梁朝偉', leaveDataFrom:'人工設定'},
                { mani:'123', empId: '1050331-001', empName: '蔡政揚', empLeave:'2021/09/09 08:00-2021/09/10 17:00', agentId:'1050330-001', agentName:'梁朝偉', leaveDataFrom:'差假管理系統'},
                { mani:'123', empId: '1050331-002', empName: '張芊芊', empLeave:'2021/09/06 08:00-2021/09/08 17:00', agentId:'1050331-003', agentName:'江舒語', leaveDataFrom:'人工設定'},
                { mani:'123', empId: '1050331-003', empName: '江舒語', empLeave:'2021/09/01 08:00-2021/09/04 17:00', agentId:'1050331-002', agentName:'張芊芊', leaveDataFrom:'差假管理系統'},
            ];
        }
    }  
}