...
export default{
    data(){
        return{
            ...
            //調閱原因清單-先放假資料
            readReasonOpt:[
                {reason:'確認換表指數及內容', reasonCode:'REASON01'},
                {reason:'確認設備容量', reasonCode:'REASON02'},
                {reason:'確認是否須拆除外線', reasonCode:'REASON03'},
                {reason:'確認用電地址', reasonCode:'REASON04'},
                {reason:'確認中抄指數', reasonCode:'REASON05'},
                {reason:'前用戶異議單獨過戶', reasonCode:'REASON06'},
                {reason:'電表報損確認賠償費用', reasonCode:'REASON07'},
                {reason:'新增設案件抽查', reasonCode:'REASON08'},
                {reason:'現場用電用途查核', reasonCode:'REASON09'},
                {reason:'完工結算', reasonCode:'REASON10'},
            ],
            readFormHeaders: [
